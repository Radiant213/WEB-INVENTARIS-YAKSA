...
class ItemsPerGudangSheet implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnWidths, WithTitle
{
    protected $gudang;
    protected $startDate;
    protected $endDate;

    public function __construct(string $gudang, $startDate = null, $endDate = null)
    {
        $this->gudang = $gudang;
    ...
    {
        $query = Item::with(['transactions' => function ($q) {
    ...
    {
        return 'Gudang ' . ($this->gudang === 'sfp' ? 'SFP' : ucfirst($this->gudang));
    }
        ...
        if ($lastRow > 1) {
            ...
            for ($row = 2; $row <= $lastRow; $row++) {
                ...
                $color = match ($statusVal) {
                    ...
                    'Barang RMA' => '7E22CE',      // purple
                    'Barang Rusak' => 'DC2626',    // red
