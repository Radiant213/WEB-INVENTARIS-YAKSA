...
<div x-data="{ loaded: false }" x-init="setTimeout(() => loaded = true, 50)">
    <div class="flex justify-between items-center mb-6"
        ...
        <a href="{{ route('items.index') }}" class="px-4 py-2.5 bg-white border border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all duration-200 flex items-center gap-2 no-underline">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm max-w-3xl"
        ...
        <form method="POST" action="{{ route('items.update', $item) }}" class="space-y-6">
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                <a href="{{ route('items.index') }}" class="px-6 py-3 bg-white border border-gray-300 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all duration-200 no-underline">Batal</a>
