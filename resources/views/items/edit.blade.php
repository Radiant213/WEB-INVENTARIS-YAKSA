        ...
        <form method="POST" action="{{ route('items.update', $item) }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <select name="status" id="status" required class="block w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-yaksa-red/20 focus:border-yaksa-red shadow-sm transition-all text-gray-700 outline-none cursor-pointer bg-white">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="status_barang" id="status_barang" value="{{ old('status_barang', $item->status_barang) }}"
                           class="block w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-yaksa-red/20 focus:border-yaksa-red shadow-sm transition-all text-gray-700 outline-none"
                ...
                <div class="space-y-1.5">
                    ...
                    <select name="lokasi_device" id="lokasi_device" class="block w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-yaksa-red/20 focus:border-yaksa-red shadow-sm transition-all text-gray-700 outline-none cursor-pointer bg-white">
                        <option value="">-- Opsional --</option>
            ...
            <div class="space-y-1.5 mt-6">
                ...
                <textarea name="description" id="description" rows="3"
                          class="block w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-yaksa-red/20 focus:border-yaksa-red shadow-sm transition-all text-gray-700 outline-none resize-none">{{ old('description', $item->description) }}</textarea>
            </div>
            <div class="pt-6 border-t border-gray-100 flex justify-end gap-3 mt-6">
                <a href="{{ route('items.index', ['gudang' => $item->gudang]) }}" class="px-5 py-2.5 bg-white border border-gray-300 rounded-xl text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors shadow-sm no-underline">Batal</a>
